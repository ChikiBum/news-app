...
export default function NewsFeedPage() {
	...
	if (isError)
		return <div className="p-4 text-red-600">Помилка: {error.message}</div>;

	return (
		<div className="max-w-4xl mx-auto p-4 min-h-[calc(100vh-120px)] flex flex-col">
			<h1 className="text-3xl font-bold mb-6 flex-shrink-0">Новини</h1>
			...
			<div className="flex-1 overflow-y-auto max-h-[calc(100vh-320px)]">
				{!news || news.length === 0 ? (
					<div className="text-center py-8 bg-gray-50 rounded-lg">
						<p className="text-gray-600">Новин поки немає</p>
						<p className="text-sm text-gray-500 mt-1">
							Додайте RSS фід щоб завантажити новини
						</p>
					</div>
				) : (
					<>
						<p className="text-gray-600">Новини:</p>
